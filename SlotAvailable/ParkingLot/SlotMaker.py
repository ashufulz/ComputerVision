...
WIDTH = 90                      # width of each slot
HEIGHT = 35                     # height of each slot

TOTAL_SLOTS = 104               # total number of slots in the parking space
...
class Slots:
    def __init__(self):
        ...
        # All Left-Top coordinates for boxes of all columns
        self.all_cols = [
